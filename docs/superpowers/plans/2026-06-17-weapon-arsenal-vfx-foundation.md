...
- [ ] **Step 3: 新建 `autoloads/vfx.gd`（仅注册表 + getter；工厂方法后续任务补）**
...
- [ ] **Step 3: 在 `autoloads/vfx.gd` 追加实现**
...
- [ ] **Step 1: 写失败测试（追加到 `tests/test_vfx_spawn.gd`）**
...
- [ ] **Step 3: 改 `autoloads/game_feel.gd`**
...
- [ ] **Step 5: 回归既有 GameFeel 相关测试**（确认改名/新增未破坏既有反馈）
...
- [ ] **Step 3: 改 `scenes/enemies/enemy.gd`**
